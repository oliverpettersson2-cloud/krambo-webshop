...
const loi = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      h2("Syfte"),
      p("Denna avsiktsförklaring bekräftar parternas gemensamma avsikt att teckna ett fullständigt tjänsteavtal om leverans och drift av en webshop för constcollection.com. Avtalet ska ha driftstart 1 augusti 2026 och signeras senast 25 juli 2026."),

      h2("Preliminära villkor"),
      bullet("Månadsavgift: 549 kr inkl. moms (för år 1)."),
      bullet("Inget setup, ingen provision på försäljningar."),
      bullet("Avtalstid: 12 månader från 1 augusti 2026."),
      bullet("Uppsägning: senast 3 månader innan avtalsslut. Annars förlängs avtalet automatiskt 12 månader med +5 % prisjustering."),
      bullet("Volymtrappa: över 25 verk i galleriet tillkommer +50 kr/mån per påbörjade 25 verk."),
      ...
      bullet("Cecilia bekräftar tryckleverantör (befintlig eller vald efter Olivers rekommendation)."),
      bullet("Cecilia granskar och godkänner demo-sajten (texter, layout, biografi)."),
...
const avtal = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        spacing: { after: 300 },
        border: { bottom: { color: INK, size: 12, style: BorderStyle.SINGLE, space: 4 } },
        children: [new TextRun({ text: "Art by Cecilia K. · constcollection.com · Driftstart 1 augusti 2026", size: 20, italics: true, color: MUTED, font: "Calibri" })],
      }),
      ...
      p("Följande faller utanför fast månadsavgift och offereras separat vid behov: större designändringar, tilläggssidor utöver shoppen, professionell bildtagning av verk, marknadsföring och SEO-arbete utöver standard."),

      h2("§4 Pris och betalning"),
      p("Månadsavgift: 549 kr inklusive moms (för avtalets första 12 månader)."),
      p("Faktura utställs månadsvis och förfaller 20 dagar efter fakturadatum."),
      p("Vid avtalsförlängning enligt §5 justeras månadsavgiften upp med 5 %."),
      p("Volymtrappa: Om Beställarens galleri omfattar mer än 25 aktiva verk tillkommer 50 kr/mån per påbörjade 25 verk över tröskeln."),

      h2("§5 Avtalstid och uppsägning"),
      p("Avtalet börjar gälla från driftstart den 1 augusti 2026 och löper i 12 månader."),
  ...
  bullet("Ansvarar själv för samtliga verksfoton, porträttbilder och övrigt bildmaterial. Leverantören utför inte fotografering."),
      ...
      bullet("Skyddar Beställarens innehåll och kunddata enligt GDPR."),
