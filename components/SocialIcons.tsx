...
const ICONS: { key: keyof typeof social; label: string; path: string }[] = [
  ...
  },
  {
    key: "linkedin",
    label: "LinkedIn",
    path: "M6.94 8.5a1.44 1.44 0 1 0 0-2.88 1.44 1.44 0 0 0 0 2.88zM5.75 9.75h2.38v8.75H5.75V9.75zm4.13 0h2.28v1.2h.03c.32-.6 1.1-1.24 2.26-1.24 2.42 0 2.87 1.59 2.87 3.66v5.13h-2.38v-4.55c0-1.08-.02-2.48-1.51-2.48-1.51 0-1.74 1.18-1.74 2.4v4.63H9.88V9.75z",
  },
  {
    key: "mail",
    label: "E-post",
