...
const standardFormats = (): Format[] => [
  {
    id: "poster-40x50",
    name: { sv: "Poster 40×50 cm", en: "Poster 40×50 cm" },
    priceSEK: 500,
    description: {
      sv: "Tryckt på blankt fotografiskt papper. Format 40×50 cm. Levereras i rör, oramad.",
      en: "Printed on glossy photographic paper. Size 40×50 cm. Shipped rolled in a tube, unframed.",
    },
    leadTime: { sv: "5-7 dagar", en: "5-7 days" },
  },
  {
    id: "poster-50x70",
    name: { sv: "Poster 50×70 cm", en: "Poster 50×70 cm" },
    priceSEK: 900,
    description: {
      sv: "Tryckt på blankt fotografiskt papper. Format 50×70 cm. Levereras i rör, oramad.",
      en: "Printed on glossy photographic paper. Size 50×70 cm. Shipped rolled in a tube, unframed.",
    },
    leadTime: { sv: "5-7 dagar", en: "5-7 days" },
  },
  {
    id: "print-40x50",
    name: { sv: "Fine art print 40×50 cm", en: "Fine art print 40×50 cm" },
    priceSEK: 1200,
    description: {
      sv: "Signerat och numrerat konsttryck på Hahnemühle Studio Lustre 250 g arkivpapper. Begränsad upplaga om 40 st.",
  ...
  {
    id: "print-50x70",
    name: { sv: "Fine art print 50×70 cm", en: "Fine art print 50×70 cm" },
    priceSEK: 1600,
    description: {
      sv: "Signerat och numrerat konsttryck på Hahnemühle Studio Lustre 250 g arkivpapper. Begränsad upplaga om 40 st.",
      en: "Signed and numbered art print on Hahnemühle Studio Lustre 250 g archival paper. Limited edition of 40.",
  ...
  {
    id: "plexi-15x20",
    name: { sv: "Plexiglas 15×20 cm i presentlåda", en: "Plexiglass 15×20 cm in gift box" },
    priceSEK: 2500,
    description: {
      sv: "Verket tryckt på plexiglas 15×20×2,5 cm. Levereras i presentlåda 25×25×2,5 cm.",
      en: "The artwork printed on plexiglass 15×20×2.5 cm. Delivered in a gift box 25×25×2.5 cm.",
    },
    leadTime: { sv: "Tryckt på beställning, 10-14 dagar", en: "Made to order, 10-14 days" },
  },
];
...
export const products: Product[] = [
  {
    ...
    name: "Adam",
    year: 2022,
    description: { sv: "Akryl på duk · 2022", en: "Acrylic on canvas · 2022" },
    story: {
  ...
  },
  {
    ...
    year: 2024,
    description: { sv: "Akryl på duk · 2024", en: "Acrylic on canvas · 2024" },
    story: {
  ...
  },
  {
    ...
    name: "Eve",
    year: 2021,
    description: { sv: "Akryl på duk · 2021", en: "Acrylic on canvas · 2021" },
    story: {
  ...
  },
  {
    ...
    name: "Jikinya",
    year: 2023,
    description: { sv: "Akryl på duk · 2023", en: "Acrylic on canvas · 2023" },
    story: {
