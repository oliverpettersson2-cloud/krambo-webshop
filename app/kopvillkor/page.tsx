    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mt-10 space-y-8 text-ink/80 leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            {isEn
              ? "constcollection.com is operated by Cecilia Kristoffersson (\"Const Collection Art by Cecilia K.\"), Växjögatan 5F, 252 51 Helsingborg, Sweden. All artworks and prints are sold directly by the artist. For questions, contact "
              : "constcollection.com drivs av Cecilia Kristoffersson (\"Const Collection Art by Cecilia K.\"), Växjögatan 5F, 252 51 Helsingborg. Alla verk och tryck säljs direkt av konstnären. Frågor besvaras på "}
